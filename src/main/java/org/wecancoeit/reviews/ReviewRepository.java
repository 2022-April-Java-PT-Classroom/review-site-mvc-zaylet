...
public class ReviewRepository {
    ...
    public ReviewRepository(){
        ...
        Review empanadillas = new Review(3L, "Empanadillas", "/images/empanadillas.jpg", "Appetizer", "We make this with almost any protein as well, some that are very popular in Puerto Rico are: beef, chicken, pizza, fish, and crab. I am not a fan of the fish and crab but that is just because I am not a fan of fish. I can describe the flavor but these are a must have, definitely try if given the chance.");
